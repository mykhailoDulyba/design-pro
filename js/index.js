...
function init() {
  ...
  $(".work-bt").click(function(){
    ...
    if (value == "all")  {
      $(".filter").removeClass("selected-gallery-item");
    } else  {
      $(".filter").not("."+value).addClass("selected-gallery-item");
      $(".filter").filter("."+value).removeClass("selected-gallery-item");
      
    }
    
    $(".work-bt").each((el, val) => {
      let currentNav = $(val).attr("data-filter");
      if(currentNav !== value){
        val.classList.remove('active-filter-button');        
      }            
    });
...
function startCounter(isCounterSterted) {
  if (!isCounterSterted) {
    $('.count').each(function() {
      var $this = this;
 ...
 // Navigation function
  ...
  navLinks.click(function(){
    ...
    if(target === 'about'){      
      ...
      startCounter(isCounterSterted)
      isCounterSterted = true;
    } else if(target === 'home'){
...
$('#play-video').click(function () { 
  ...
  $('#stop-video').click(function () { 
    ...
    $('.payer-control').css("transform", "translate(100%, -100%)");
    player.pauseVideo();
    });
